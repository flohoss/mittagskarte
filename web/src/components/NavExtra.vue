...
<template>
    <div class="row q-gutter-x-sm">
        <RestaurantInfo v-if="$q.screen.gt.sm && restaurant.image_url !== ''" :restaurant="restaurant" :icon-size="iconSize" />
        <RestaurantActions :restaurant="restaurant" :icon-size="iconSize" />
        <q-btn :size="iconSize" round flat icon="fa-solid fa-gear" @click="settings = true" id="settings-btn" aria-label="Einstellungen">
